    ...
    <div class="w-full h-full bg-gray-800 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0 z-10" id="chec-div">
        <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="notification" @click="onclose">
            ...
            <div class="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0">
                ...
                <!--nội dung thông báo-->
                <h2 tabindex="0" class="focus:outline-none text-sm leading-normal pt-8 border-b pb-2 border-gray-300 text-gray-600">Ngày</h2>
                <div class="w-full p-3 mt-8 bg-white rounded flex">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class="focus:outline-none text-sm leading-none"><span class="text-indigo-700">Người gửi</span> Bạn có thông báo lmao <span class="text-indigo-700">Bài đăng</span></p>
                        <p tabindex="0" class="focus:outline-none text-xs leading-3 pt-1 text-gray-500">thời gian so với hiện tại</p>
                    </div>
                </div>
                <!--nội dung thông báo-->
